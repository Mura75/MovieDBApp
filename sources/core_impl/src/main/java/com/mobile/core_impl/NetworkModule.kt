...
import com.mobile.core_api.network.MovieDbMainApi
...
class NetworkModule(private val context: Context) {
    ...
    @Provides
    @Singleton
    fun provideApiService(retrofit: Retrofit): MovieDbMainApi {
        return retrofit.create(MovieDbMainApi::class.java)
    }
